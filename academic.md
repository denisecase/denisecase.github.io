...
* [NW 44-386 Digital Forensics **NEW Digital Forensics!**](https://profcase.github.io/44-386-digital-forensics-syllabus/) (Fall 2019)
* [NW 44-499 Independent Study Computer Science.](http://www.nwmissouri.edu/csis/msacs/courses.htm) (Fall 2019, Spring 2017, Fall 2016, Spring 2016)
* [NW 44-517 Big Data.](https://profcase.github.io/44-517-bigdata-syllabus/) (Spring 2020, Fall 2019)
* [NW 44-542 Object-Oriented Programming.](http://www.nwmissouri.edu/csis/msacs/courses.htm) (Fall 2015)
* [NW 44-563 Developing Web Applications and Services.](http://www.nwmissouri.edu/csis/msacs/courses.htm) (Fall 2017, Spring 2017, Fall 2016)
...
* [NW 44-663 Component-Based Software Engineering: Application Development in C#.NET. **NEW .NET Core!**](http://www.nwmissouri.edu/csis/msacs/courses.htm) (Fall 2017, Spring 2016)
* [NW 44-691 Graduate Directed Project I.](http://www.nwmissouri.edu/csis/msacs/courses.htm)
...
* [NW 44-564 Design of Data Intensive Systems.](http://www.nwmissouri.edu/csis/msacs/courses.htm) (Spring 2017)
...
*   **Denise M. Case**, Chrysostomos Stylios, ["Introducing a Fuzzy Cognitive Map for Modeling Power Market Auction Behavior"](http://ieeexplore.ieee.org/xpl/tocresult.jsp?isnumber=7849361). At 2016 IEEE Symposium Series on Computational Intelligence, Athens, Greece, December 8, 2016.
*   **Denise M Case**, Nathan Eloe, Jennifer Leopold, ["Scaffolding Version Control into the Computer Science Curriculum"](http://ksiresearch.org/seke/dms16paper/dms16paper_36.pdf). At 22nd International Conference on Distributed Multimedia Systems, Salerno, Italy, November 26, 2016. 
*   Nathan Eloe, **Denise M Case**, Jennifer Leopold, ["VeCVL: A Visual Language for Version Control"](http://ksiresearch.org/seke/dms16paper/dms16paper_27.pdf). At 22nd International Conference on Distributed Multimedia Systems, Salerno, Italy, November 25, 2016. 
...
*   **Denise M. Case**, M. N. Faqiry, B. P. Majumder, S. Das, and Scott. A. DeLoach. "Implementation of a two-tier double auction for on-line power purchasing in the simulation of a distributed intelligent cyber-physical system". In Research in Computing Science, 2014, presented at the Mexican International Conference on Artificial Intelligence, 2014. ([bib]({{ '/' | relative_url }}public/cite/case2014implementation.txt))
*   **Denise M. Case**. "Distributed Intelligent Systems: Agent Self Control and Consistency Management in Complex Adaptive Systems," presented at the Mexican International Conference on Artificial Intelligence, Doctoral Consortium 2014 ([bib]({{ '/' | relative_url }}public/cite/case2014distributed.txt)). 
*   **Denise M. Case**, Scott A. DeLoach, ["OBAA++: An Agent Architecture for Participating in Multiple Groups"](http://aamas2014.lip6.fr/proceedings/aamas/p1367.pdf), 13th International Conference on Autonomous Agents and Multiagent Systems ([http://aamas2014.lip6.fr](http://aamas2014.lip6.fr/)) ([bib]({{ '/' | relative_url }}public/cite/case2014obaa.txt)). 
*   **Denise M. Case**, ["Engineering Multigroup Agents for Complex Cooperative Systems"](http://aamas2014.lip6.fr/proceedings/aamas/p1707.pdf), Doctoral Consortium, 13th International Conference on Autonomous Agents and Multiagent Systems, AAMAS ([http://aamas2014.lip6.fr](http://aamas2014.lip6.fr/)) ([bib]({{ '/' | relative_url }}public/cite/case2014engineering.txt)). 
*   **Denise M. Case**, Scott A. DeLoach, ["Applying an O-MaSE Compliant Process to Develop a Holonic Multiagent System for the Evaluation of Intelligent Power Distribution Systems"](http://link.springer.com/chapter/10.1007%2F978-3-642-45343-4_5), 1st International Workshop on Engineering Multi-Agent Systems (EMAS) Workshop (2013) ([emas2013.otago.ac.nz](http://emas2013.otago.ac.nz/)) at the Twelfth International Conference on Autonomous Agents and Multiagent Systems, AAMAS ([aamas2013.cs.umn.edu](http://aamas2013.cs.umn.edu/)). Conference Paper, Presented, 05.2013 ([bib]({{ '/' | relative_url }}public/cite/case2013applying.txt)). 

## Dissertation

*   Denise M. Case, ["Engineering Complex Systems with Multigroup Agents"](https://krex.k-state.edu/dspace/handle/2097/19045), 
Kansas State University, April 22, 2015 ([bib]({{ '/' | relative_url }}public/cite/case2015engineering.txt)). 
...
*   Curricular Unit: Enhancing Health - Sensors in Wellness, Health, and Medicine. [[PDF]({{ '/' | relative_url }}public/docs/HealthUnit.pdf)] [[Google Doc](https://docs.google.com/document/d/1TJeEoQRaYQ2xFPDCxJdhJnRbASrcMcUBRCK26EoicSQ/pub)]
*   Curricular Unit: Rocket Out! Exploring Thrust, Acceleration, Velocity, and Flight Performance with Sensors. [[PDF]({{ '/' | relative_url }}public/docs/RocketUnit.pdf)] [[Google Doc](https://docs.google.com/document/d/1PNwke31zeNBXboUKUKaFo0-wiliwLO9eYyct8lfCdZw/pub)]
*   Curricular Unit: This Little Light of Mine: Exploring Light with Sensors and Bots. [[PDF]({{ '/' | relative_url }}public/docs/LightUnit.pdf)] [[Google Doc](https://docs.google.com/document/d/1jOeKGLvDXSPptcn6e-PXRppIQCLMFoP1IekbsZh_nCo/pub)]
*   Curricular Unit: Dig it! Composting Analysis with Temperature Sensors. [[PDF]({{ '/' | relative_url }}public/docs/CompostingAnalysisUnit.pdf)] [[Google Doc](https://docs.google.com/document/d/1gmjvLYA-Zjqt5qA335pMD4XAQQtANon8vGJC9qzTV0Q/pub)]
*   Activity: Assessing the Power of Exercises with Sensors. [[PDF]({{ '/' | relative_url }}public/docs/HealthActivity.pdf)] [[Google Doc](https://docs.google.com/document/d/1PRZL1qdwVnQDXz0PVbw6qwDkPCBY7UyyGfBAXny3mxo/pub)]
*   Activity: Creating a Simple Digital Movie: Getting Started with Alice Storytelling. [[PDF]({{ '/' | relative_url }}public/docs/GettingStartedwithAliceStorytelling.pdf)] [[Google Doc](https://docs.google.com/document/d/1D18xQwWTCNaiky7F4EJv2_MbxA-rUWxZ5sl1YMK2JaE/pub)]
*   Activity: Kicking off the Composting Design Experiment. [[PDF]({{ '/' | relative_url }}public/docs/KickingOffComposting.pdf)] [[Google Doc](https://docs.google.com/document/d/16YXKGG-0uyzPZJCVD9JVTaUioqNyCiURXtKCtBazQDA/pub)]
